        ...
        <div className="bg-[#FFFFFF] w-[100%] h-[750px] ml-[3%] mr-[3%]">
          ...
          <div className="grid grid-cols-12 font-[poppins]">
            <div className="col-span-6 ml-[5%] pt-[31px] flex flex-col space-y-[23px] justify-start items-start">
              <label className="font-[600] text-[18px] leading-[27px] text-[#374557]">Class assigned*</label>
              <div className="flex gap-2">
                <input type="checkbox" className="  " checked readOnly />
                <label className="font-[400] text-[18px] leading-[27px] text-[#374557]">English 1:1</label>
              </div>
              <div className="flex gap-2">
                <input type="checkbox" className="  " checked readOnly />
                <label className="font-[400] text-[18px] leading-[27px] text-[#374557]">Group Math</label>
              </div>
            </div>
            <div className="hidden col-span-6 pt-[31px]  flex flex-col ml-[5%]">
              <div className="flex justify-start  space-x-[18rem]  items-center">
                <label className="font-[600] text-[18px] leading-[27px] text-[#374557]">Attachments</label>
              </div>
              <button className="mt-[16px] flex gap-2 justify-start items-center p-[17px] w-[50%] max-w-[323px] bg-[#374557]">
                <img src="/images/Vector (2).svg" alt="img" />
                <h1 className=" font-[600] text-[18px] leading-[27px] text-[#FFFFFF]">New Student Attachment</h1>
              </button>
            </div>
          </div>
          {/* 6th row */}
